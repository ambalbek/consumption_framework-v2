...
class Consumption:
    def __init__(
        ...
        aws_cost_explorer_config: Optional[Dict[str, Any]] = None,
        force: bool = False,
        ...
        self.aws_cost_explorer_config = aws_cost_explorer_config
    ...
    def consume_monitoring(
        ...
        monitoring_analyzer(
            ...
            aws_cost_explorer_config=self.aws_cost_explorer_config,
        )
