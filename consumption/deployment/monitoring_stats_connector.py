...
class IndexStats(Stats):
    ...
    def search_as_dataframe(
        ...
        column_mapping = {
            ...
            "dv_elasticsearch.index.total.store.size.bytes": "total_store_size_in_bytes_delta",
            "dv_elasticsearch.index.total.store.total_data_set_size.bytes": "total_data_set_size_in_bytes_delta",
            "dv_elasticsearch.index.primaries.store.size.bytes": "primary_store_size_in_bytes_delta",
            "dv_elasticsearch.index.primaries.store.total_data_set_size.bytes": "primary_data_set_size_in_bytes_delta",
            ...
            "elasticsearch.index.total.store.size.bytes": "total_store_size_in_bytes",
            "elasticsearch.index.total.store.total_data_set_size.bytes": "total_data_set_size_in_bytes",
            "elasticsearch.index.total.docs.count": "total_docs_count",
            "elasticsearch.index.primaries.store.size.bytes": "primary_store_size_in_bytes",
            "elasticsearch.index.primaries.store.total_data_set_size.bytes": "primary_data_set_size_in_bytes",
